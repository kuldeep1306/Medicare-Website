...
const DEFAULT_HOST = "https://medicare-website-6.onrender.com".replace(/\/$/, "");
...
export default function ServiceDetail() {
  ...
  const [paymentMethod, setPaymentMethod] = useState("NotApplicable");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        paymentMethod: paymentMethod === "Cash" ? "Cash" : "NotApplicable",
              ...
              <div className={serviceDetailStyles.paymentOptions}>
                ...
                >
                  <input
                    ...
                    name="payment"
                    value="NotApplicable"
                    checked={paymentMethod === "NotApplicable"}
                    onChange={() => setPaymentMethod("NotApplicable")}
                    className={serviceDetailStyles.paymentInput}
                  />
                  NotApplicable
                </label>
