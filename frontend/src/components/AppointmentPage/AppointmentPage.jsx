...
const API_BASE = import.meta.env.VITE_API_URL || "https://medicare-website-6.onrender.com";
...
const PaymentBadge = ({ payment }) => {
  return payment === "NotApplicable" ? (
    <span className={badgeStyles.paymentBadge.NotApplicable}>
      <CreditCard className={iconSize.small} /> NotApplicable
    </span>
  ) : (
