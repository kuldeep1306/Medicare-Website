...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    
    {
      ...
      name: "Instagram",
      href: "instagram.com/deepindiary?igsh=MW5lNXYxeHp5bjFydA==",
    },
    {
      Icon: Linkedin,
      color: footerStyles.linkedinColor,
      name: "LinkedIn",
      href: "https://www.linkedin.com/in/kuldeepkh1305?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    },
    {
      Icon: Youtube,
      color: footerStyles.youtubeColor,
      name: "YouTube",
      href: "www.youtube.com/@deepindiaryy",
    },
  ];
          ...
          <div className={footerStyles.companySection}>
            ...
            <div className={footerStyles.contactContainer}>
              <div className={footerStyles.contactItem}>
                ...
                <span className={footerStyles.contactText}>+91 8433202325</span>
              </div>
              <div className={footerStyles.contactItem}>
                <div className={footerStyles.contactIconWrapper}>
              ...
              <div className={footerStyles.contactItem}>
                ...
                <span className={footerStyles.contactText}>Ghaziabad, India</span>
              </div>
            </div>
          </div>
